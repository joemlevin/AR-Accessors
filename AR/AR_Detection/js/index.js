...
var app = {
    ...
    onDeviceReady: function() {
        ...
        app.loadCustomARchitectWorldFromURL(app.ar_path);
    },
    // --- Wikitude Plugin ---
    ...
    onJSONObjectReceived: function (jsonObject) {
        // var html = "<button type='button'>LED ON</button>";
        app.wikitudePlugin.callJavaScript("World.constructUI();");
